    ...
    <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
      ...
      <img src={image} class="mr-5 h-6 sm:h-9" alt="logo" />
        ...
        <div class="flex mt-8 space-x-6 text-gray-300">
          ...
          <a class="hover:opacity-75" href="https://instagram.com/parati.in/" target="_blank" rel="noreferrer">
    ...
    <svg class="w-4 h-4 md:w-6 md:h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
      ...
      <div class="grid grid-cols-1 gap-8 lg:col-span-2 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div>
          ...
          <nav class="flex flex-col mt-4 space-y-2 text-sm text-gray-300">
            <a class="hover:opacity-75 hover:text-yellow-500" href> Business Strategy </a>
            <a class="hover:opacity-75 hover:text-yellow-500" href> Investor Relation </a>
            <a class="hover:opacity-75 hover:text-yellow-500" href> Managed Operations </a>
            <a class="hover:opacity-75 hover:text-yellow-500" href> Digital Transformation </a>
          </nav>
        </div>
        <div>
          <p class="font-medium text-white">
          ...
          <nav class="flex flex-col mt-4 space-y-2 text-sm text-gray-300">
            <a class="hover:opacity-75 hover:text-yellow-500" href> Contact </a>
            <a class="hover:opacity-75 hover:text-yellow-500" href> Blog </a>
          </nav>
        </div>
        <div>
          <p class="font-medium text-white">
          ...
          <nav class="flex flex-col mt-4 space-y-2 text-sm text-gray-300">
            ...
            <a class="hover:opacity-75 hover:text-yellow-500" href> Accessibility </a>
          </nav>
        </div>
      </div>
    </div>
