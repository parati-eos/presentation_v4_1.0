...
export default function AnimatedButon({onclicked,name}) {
  return (
    <button onClick= {onclicked} className="button-85 relative overflow-hidden bg-transparent text-white py-2 px-8 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 rounded-full transition duration-300 ease-in-out transform hover:translate-y-1">
    {name}
